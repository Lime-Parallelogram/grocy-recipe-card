...
window.customCards.push({
    type: "grocy-recipe-card",
    name: "Grocy Recipe Card",
    description: "A card to display the ingredients and method for entries on your meal plan",
    configurable: true,
    preview: true,
});
    ...
    _renderIngredientsList(recipeID, recipeServings) {
        ...
        for (let [sectionName, sectionIngredients] of Object.entries(ingredients)) {
            ...
            sectionIngredients.forEach(element => {
                ...
                ingredientEntry.style.flex = `${100/this._config.ingredientsColumns}%`
                ingredientEntry.style.maxWidth = `${100/this._config.ingredientsColumns}%`
...
customElements.define("grocy-recipe-card", IngredientsCard);
